    ...
    if request.method == "GET":
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'todo/signupuser.html', {'form':UserCreationForm(), 'error':'Username already taken. Use another one.'})
        else:
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/viewtodo.html', {'todo':todo, 'form':form, 'error':'Unable to save'})
